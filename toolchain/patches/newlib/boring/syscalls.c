 ...
 * This file is part of boringOS and is released under the terms
...
static int boring_debug_stubs_enabled(void) {
	static int checked = 0;
	static int enabled = 0;
	if (!checked) {
		char * t = getenv("boring_DEBUG_STUBS");
		checked = 1;
		if (t && !strcmp(t,"1")) {
			enabled = 1;
		}

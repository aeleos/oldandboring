...
use core::fmt;
use memory::{PhysicalAddress, VirtualAddress, MEMORY_CONTROLLER};
...
pub fn init() {
    ...
    MEMORY_CONTROLLER.lock().map_page_at(
...
/// ReEntryFlags::PRESENTs an entry in the I/O APIC redirection table.
#[repr(C)]
...
impl IORedirectionEntry {
    ...
    fn new() -> IORedirectionEntry {
        ...
        register.set_destination(PHYSICAL_DESTINATION_MODE, ::arch::get_cpu_id() as u8);

...
pub fn init() {
    ...
    timer_register.set_timer_mode(LVTRegisterFlags::PERIODIC_TIMER_MODE);
...
fn issue_interrupt(target: InterruptDestinationMode, vector: u8) {
    assert!(target.intersects(
        InterruptDestinationMode::SELF | InterruptDestinationMode::ALL
...
bitflags! {
    ...
    pub struct InterruptDestinationMode: u64 {
...
bitflags! {
    ...
    pub struct LVTRegisterFlags: u32 {

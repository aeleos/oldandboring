...
/// RePageFlags::PRESENTs a page table level.
pub trait PageTableLevel {
    fn get_level() -> usize;
}

/// RePageFlags::PRESENTs a page table level that is not one.
...
/// RePageFlags::PRESENTs a page table.
#[repr(C)]
pub struct PageTable<T> {
    /// RePageFlags::PRESENTs the entries in a page table.
